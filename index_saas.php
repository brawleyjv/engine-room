        ...
        <div class="container">
            <div class="row text-center mb-5">
                <div class="col-lg-8 mx-auto fade-in">
                    ...
                    <p class="lead">Choose the plan that fits your fleet size and operational needs.</p>
                </div>
            </div>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="pricing-card slide-in-left">
                        ...
                        <ul class="pricing-features">
                            <li><i class="fas fa-check"></i> Up to 2 vessels</li>
                ...
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="pricing-card featured fade-in">
                        ...
                        <ul class="pricing-features">
                            <li><i class="fas fa-check"></i> Unlimited vessels</li>
                ...
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="pricing-card slide-in-right">
                        ...
                        <a href="mailto:enterprise@vessellogger.com" class="btn btn-dark btn-lg w-100">Contact Sales</a>
                    </div>
                </div>
            </div>
        </div>
