<?php
/**
 * Fix remaining require_once statements in vessel/engineroom folder
 */

$engineroom_path = __DIR__ . '/vessel/engineroom/';
$files = glob($engineroom_path . '*.php');
...
echo "\nDone fixing vessel/engineroom files!\n";
?>
